...
"verifyText | xpath=//div[3]/a/div | ESM退款/取消API通知 | verify text on btn_ESM API Notification Revert"
verifyEquals("ESM退款/取消API通知", selenium.getText("xpath=//div[3]/a/div"))

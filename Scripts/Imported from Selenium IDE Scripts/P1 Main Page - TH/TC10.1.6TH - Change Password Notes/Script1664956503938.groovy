...
'Generated date: 05-Oct-2022 03:55:03 PM'
...
"verifyText | xpath=//form/div[3] | รหัสผ่านใหม่ของคุณจะต้อง:\\n*มีอย่างน้อย 8 ตัวอักษร (สูงสุด 15 ตัวอักษร)\\n*รวมตัวเลขและตัวอักษรอย่างน้อยหนึ่งตัว\\n*ไม่อนุญาตให้ใช้อักขระพิเศษ | verify the notes"
verifyTrue(selenium.getText("xpath=//form/div[3]").matches("รหัสผ่านใหม่ของคุณจะต้อง:\n.*มีอย่างน้อย 8 ตัวอักษร (สูงสุด 15 ตัวอักษร)\n.*รวมตัวเลขและตัวอักษรอย่างน้อยหนึ่งตัว\n.*ไม่อนุญาตให้ใช้อักขระพิเศษ"))

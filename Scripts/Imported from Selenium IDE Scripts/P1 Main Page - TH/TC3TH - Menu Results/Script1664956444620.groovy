...
"verifyText | xpath=//div/div[3]/div/div | ผลลัพธ์ | verify text on btn_Results"
verifyEquals("ผลลัพธ์", selenium.getText("xpath=//div/div[3]/div/div"))

"click | css=.open |  | verify if btn_Results clicked"

...
"verifyText | xpath=//div[3]/a/div | การแจ้งการคืนเงิน/การยกเลิก ESM API | verify text on btn_ESM API Notification Revert"
verifyEquals("การแจ้งการคืนเงิน/การยกเลิก ESM API", selenium.getText("xpath=//div[3]/a/div"))

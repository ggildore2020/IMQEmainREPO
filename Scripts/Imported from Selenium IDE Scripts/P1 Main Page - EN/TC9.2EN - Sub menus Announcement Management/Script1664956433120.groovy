...
"verifyText | css=.sc-hBUSln:nth-child(2) > .sc-fotOHu | Announcement Management | verify text on btn_Announcement Management"
verifyEquals("Announcement Management", selenium.getText("css=.sc-hBUSln:nth-child(2) > .sc-fotOHu"))

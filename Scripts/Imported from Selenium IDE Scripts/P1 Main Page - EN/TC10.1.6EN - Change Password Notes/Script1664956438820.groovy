...
"verifyText | xpath=//form/div[3] | Your new password MUST:\\n*Contain at least 8 characters (maximum 15 characters).\\n*Contain at least a number and letter.\\n*No special character is allowed. | verify the notes"
verifyTrue(selenium.getText("xpath=//form/div[3]").matches("Your new password MUST:\n.*Contain at least 8 characters (maximum 15 characters).\n.*Contain at least a number and letter.\n.*No special character is allowed."))
